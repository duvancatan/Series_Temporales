...
#---------------------------------------------------------------------------
# simulaci?n de un proceso MA(2) con at Normal
#---------------------------------------------------------------------------
# definici?n de los par?metros del proceso
theta0_ma2=5
theta1_ma2=0.4
theta2_ma2=-0.3
var_RB_ma2=2
...
#---------------------------------------------------------------------------
# Simulaci?n de procesos ARMA(1,1) at Normal
#---------------------------------------------------------------------------
# definici?n de los par?metros del proceso
theta0_arma11=5
phi1_arma11=0.5
...
# simulaci?n de un proceso ARMA(1,1) con at N(0,2)
